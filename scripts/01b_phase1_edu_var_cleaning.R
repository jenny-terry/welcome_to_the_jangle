...
#read in data
phase1_data <- readr::read_csv(here::here("data", "phase1_data_new.csv"))

#rename vars
phase1_data %<>%
  dplyr::rename(
    math_edu_level = q10.1, 
    math_edu_level_txt1 = q10.1_1_text, 
    math_edu_level_txt2 = q10.1_2_text, 
    math_edu_level_txt3 = q10.1_3_text, 
    math_gcse = q10.2, 
    math_alevel = q10.3, 
    math_ug = q10.4, 
    math_pg = q10.5, 
    ...
    stats_edu_level_txt1 = q10.6_1_text, 
    stats_edu_level_txt2 = q10.6_2_text, 
    stats_edu_level_txt3 = q10.6_3_text, 
    stats_gcse = q10.7, 
    stats_alevel = q10.8, 
    stats_ug = q10.9, 
    stats_pg = q10.10, 
    ...
    eth_other_specify = q11.4_11_text, 
    spld = q11.5, 
...
#readr::write_csv(phase1_data, here::here("data", "phase1_edu_processed_data.csv"), col_names = T)
